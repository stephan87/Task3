...
} __attribute__((packed)) MoteTableEntry;
...
static void TestSerialC$serialSendTask(TestSerialMsg *msgToSend);
...
#line 140
static void TestSerialC$serialSendTask(TestSerialMsg *receivedMsgToSend);
#line 157
...
enum SerialActiveMessageC$__nesc_unnamed4328 {
#line 74
...
enum SerialActiveMessageC$__nesc_unnamed4329 {
#line 75
...
#line 119
enum SerialActiveMessageC$__nesc_unnamed4330 {
#line 119
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t TestSerialC$RadioSend$send(am_id_t arg_0x40718b00, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40718b00, addr, msg, len);
#line 69
      ...
      if (TestSerialC$RadioSend$send(AM_TESTSERIALMSG, AM_BROADCAST_ADDR, &TestSerialC$sndRadio[sim_node()], sizeof(TestSerialMsg )) == SUCCESS) 
        {
          ...
          sim_log_debug(54U, "TestSerialC", "Node %d forwarded message\n", TOS_NODE_ID);
        }
    }
}
...
#line 92
          if (curEntry == (void *)0 && freeSlot != -1) 
            {
              freeSlot = i;
            }
          else 
            {
              if (__nesc_ntoh_uint16(curEntry->nodeId.nxdata) == __nesc_ntoh_uint16(msgReceived->sender.nxdata)) 
                {
                  __nesc_hton_uint16(curEntry->lastContact.nxdata, time((void *)0));
                  sim_log_debug(48U, "TestSerialC", "found entry in neighbor table - update time\n");
                }
            }
        }
      if (freeSlot == -1) {
        sim_log_debug(49U, "TestSerialC", "found NO entry in neighbor table\n");
        }
#line 107
      return msg;
    }
      ...
      if (__nesc_ntoh_uint16(msgReceived->receiver.nxdata) == TOS_NODE_ID) 
        {
          if (__nesc_ntoh_uint16(msgReceived->seqNum.nxdata) > TestSerialC$localSeqNumber[sim_node()]) 
            {
              sim_log_debug(50U, "TestSerialC", "Finished Node %d: received message on RadioChannel seqNum: %d\n", TOS_NODE_ID, __nesc_ntoh_uint16(msgReceived->seqNum.nxdata));
            ...
            {
              sim_log_debug(51U, "TestSerialC", "Node %d:duplicate message received\n", TOS_NODE_ID);
            }
        }
      else 
        {
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x4090b628, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  __nesc_result = TestSerialC$RadioReceive$receive(arg_0x4090b628, msg, payload, len);
#line 67
...
{
  LedsP$Led0$set();
  sim_log_debug(59U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP$Led0$get() ? "off" : "on");
#line 70
  ;
}
...
{
  LedsP$Led1$set();
  sim_log_debug(62U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 85
  ;
}
...
{
  LedsP$Led2$set();
  sim_log_debug(65U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 100
  ;
}

# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x408d9b98, message_t * msg, error_t error){
#line 99
  TestSerialC$RadioSend$sendDone(arg_0x408d9b98, msg, error);
#line 99
}
#line 99
...
#line 319
      ...
      sim_log_debug_clear(157U, "CpmModelC,SNRLoss", "  -signaling reception\n");
      CpmModelC$Model$receive(mine->msg);
      if (mine->ack) {
          sim_log_debug_clear(158U, "CpmModelC", " acknowledgment requested, ");
        }
      else {
          sim_log_debug_clear(159U, "CpmModelC", " no acknowledgment requested.\n");
        }
...
#line 274
  ...
  sim_log_debug(145U, "TossimPacketModelC", "PACKET: Signaling send done at %llu.\n", sim_time());
...
#line 245
{
  ...
  sim_log_debug(143U, "TossimPacketModelC", "PACKET: Broadcasting packet to everyone.\n");
  ...
  sim_log_debug(144U, "TossimPacketModelC", "PACKET: Send done at %llu.\n", evt->time);
...
#line 235
        TossimPacketModelC$sending[sim_node()] = (void *)0;
        sim_log_debug(142U, "TossimPacketModelC", "PACKET: Failed to send packet due to busy channel.\n");
...
#line 186
  ...
  backoff += sim_csma_init_low();
  backoff *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
  sim_log_debug(141U, "TossimPacketModelC", "Starting CMSA with %lli.\n", backoff);
...
{
  LedsP$Led0$toggle();
  sim_log_debug(60U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP$Led0$get() ? "off" : "on");
#line 75
  ;
}
...
#line 231
  sim_log_debug(152U, "CpmModelC,SNR", "SNR is %lf, PRR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
#line 291
      ...
      if (msg != TossimPacketModelC$sending[sim_node()]) {
          ...
          sim_log_debug(146U, "TossimPacketModelC", "Requested ack for 0x%x, but outgoing packet is 0x%x.\n", msg, TossimPacketModelC$sending[sim_node()]);
        }
    }
}
...
#line 149
  sim_log_debug(149U, "CpmModelC,SNRLoss", "SNR is %lf, ARR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x4090bcc0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x4090bcc0, msg, payload, len);
#line 67
      ...
      if (__nesc_ntoh_uint16(msgReceived->seqNum.nxdata) > TestSerialC$localSeqNumber[sim_node()]) 
        {
          ...
          if (__nesc_ntoh_uint16(msgReceived->receiver.nxdata) == TOS_NODE_ID) 
            {
              TestSerialC$Leds$set(__nesc_ntoh_uint16(msgReceived->ledNum.nxdata));
              TestSerialC$serialSendTask((TestSerialMsg *)msgReceived);
            }
          else 
            {
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * SerialActiveMessageC$Receive$receive(am_id_t arg_0x4096e108, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  __nesc_result = TestSerialC$SerialReceive$receive(arg_0x4096e108, msg, payload, len);
#line 67
...
#line 124
{
  ...
  sim_log_debug(131U, "Serial", "Sending serial message (%p) of type %hhu and length %hhu @ %s.\n", msg, SerialActiveMessageC$AMPacket$type(msg), len, sim_time_string());
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t TestSerialC$SerialSend$send(am_id_t arg_0x4071c608, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = SerialActiveMessageC$AMSend$send(arg_0x4071c608, addr, msg, len);
#line 69
...
{
  LedsP$Led1$toggle();
  sim_log_debug(63U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 90
  ;
}
  ...
  if (error == SUCCESS) 
    {
      ...
      if (&TestSerialC$sndSerial[sim_node()] == msg) 
        {
          sim_log_debug(52U, "TestSerialC", "successfully sent message over serial\n");
          TestSerialC$serialBusy[sim_node()] = FALSE;
          TestSerialC$Leds$led1Toggle();
          return;
        }
    }
  sim_log_debug(53U, "TestSerialC", "error on message pointer\n");
}

# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void SerialActiveMessageC$AMSend$sendDone(am_id_t arg_0x4096f6f0, message_t * msg, error_t error){
#line 99
  TestSerialC$SerialSend$sendDone(arg_0x4096f6f0, msg, error);
#line 99
}
#line 99
...
static inline void TestSerialC$BeaconTimer$fired(void )
{
  sim_log_debug(47U, "TestSerialC", "should send beacon\n");
}
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40bb63a8){
#line 72
  switch (arg_0x40bb63a8) {
#line 72
    case 0U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40bb63a8);
#line 72
      break;
#line 72
    }
...
#line 569
{
  sim_log_debug(199U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 537
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(198U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 473
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(195U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(196U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 291
  sim_log_debug(188U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 179
{
  sim_log_debug(178U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 186
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(184U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 217
  sim_log_debug(185U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 46
  {
    sim_log_debug(57U, "Init", "LEDS: initialized.\n");
...
#line 356
{
  sim_log_debug(190U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 118
{
  ...
  sim_log_debug(147U, "CpmModelC", "IN: noise_hash_generation()\n");
  ...
  sim_log_debug(148U, "CpmModelC,Tal", "%s: OUT: noise_hash_generation(): %lf\n", sim_time_string(), noise_val);
...
static void TestSerialC$RadioSend$sendDone(am_id_t id, message_t *msg, error_t error)
{
  if (error != SUCCESS) 
    {
      sim_log_debug(56U, "TestSerialC", "Error: Node %d couldnt send message on RadioChannel\n", TOS_NODE_ID);
    }
  else 
    {
      if (TOS_NODE_ID == 0) 
...
#line 145
      ...
      if (TestSerialC$SerialSend$send(AM_TESTSERIALMSG, AM_BROADCAST_ADDR, &TestSerialC$sndSerial[sim_node()], sizeof(TestSerialMsg )) == SUCCESS) {
...
#line 277
  ...
  sim_log_debug(187U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 449
{
  sim_log_debug(193U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(173U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(174U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(175U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(176U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 455
{
  sim_log_debug(194U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 457
  {
...
#line 500
{
  ...
  sim_log_debug(197U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 223
{
  ...
  sim_log_debug(186U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
